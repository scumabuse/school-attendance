...
const AnalyticsPage = () => {
  ...
  const [chartSortOrder, setChartSortOrder] = useState('desc'); // для "Посещаемость по группам"
  const [tableSortOrder, setTableSortOrder] = useState('desc'); // для "Детальная статистика"
