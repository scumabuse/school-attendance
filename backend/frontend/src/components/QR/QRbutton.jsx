    ...
    <>
      ...
      {isOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.8)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1001 }} onClick={() => setIsOpen(false)}>
          <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '15px', position: 'relative' }} onClick={e => e.stopPropagation()}>
            ...
            <h3 style={{ textAlign: 'center', marginBottom: '15px' }}>Покажите этот код студентам</h3>
